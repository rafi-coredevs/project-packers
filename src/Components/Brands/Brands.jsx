...
const Brands = ({ data }) => {
    ...
    return <section className="container  items-center mx-auto text-center flex justify-center flex-col mt-12 md:mt-[9.25rem] md:mb-[9.25rem]  mb-[4.25rem] px-5 gap-5">
        <h2 className="font-sans text-lg md:text-2xl md:leading-8 leading-6 tracking-[-0.36px] md:tracking-[-0.48px] text-secondary font-semibold max-w-[600px] text-center">Buy Real USA product from any band through our  Project Packers platform</h2>
