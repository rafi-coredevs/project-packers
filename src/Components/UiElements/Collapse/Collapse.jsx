  ...
  return (
    <div className='flex justify-center'>
      <div
        ...
        className="cursor-pointer py-4 border-b border-slate-200 justify-center items-start gap-[25px] inline-flex"
      >
        <div
          className={`px-[15px] py-1.5 ${expand ? "bg-primary" : "bg-[#CFF6EF]"
        ...
        <div className="flex-col justify-center items-start gap-3 inline-flex">
          ...
          <p
            className={`text-slate-600 text-base font-normal w-full max-w-[320px] leading-normal overflow-hidden transition-all duration-500 ${expand ? "h-auto opacity-100" : "h-0 opacity-0"
              }`}
          >
            {data?.description}
          </p>
