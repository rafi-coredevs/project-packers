          ...
          <div className="grid gap-3">
            ...
            <label className="text-[#475569] text-sm">Parent Category</label>
              <select
                ...
                onChange={(e) => {setSelectedcategory(e.target.value) , setSelectedsubcategory(null), setCategoryerror({
                  category: false,
                  subCategory: true,
                });}}
              ...
              <label className="text-[#475569] text-sm">Sub Category</label>
               <select
                ...
                onChange={(e) => {setSelectedsubcategory(e.target.value), setCategoryerror({
                  category: false,
                  subCategory: false,
                })}}
