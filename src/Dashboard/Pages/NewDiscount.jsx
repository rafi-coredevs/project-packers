          ...
          <div className="grid gap-3">
            ...
            <div className="border border-[#0000001c] rounded-lg p-3 grid gap-3">
              <div className="flex items-end gap-2 ">
                <Input styles="basic" name="coupon" change={discountForm.handleChange} blur={discountForm.handleBlur} error={discountForm.touched.coupon && discountForm.errors.coupon ? discountForm.errors.coupon : null} label="Coupon Code" value={discountForm.values.coupon} placeholder="Coupon" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <DateRangeSelector type={'single'} style={'border border-[#ededed] rounded-md'} onSubmit={(date)=> discountForm.setFieldValue('expiry', date)}  label={'Expiry Date'} error={discountForm.touched.expiry && discountForm.errors.expiry ? true : false} />
            ...
            <div className="border border-[#0000001c] rounded-lg p-3 grid gap-3">
              ...
              <CustomSelect appearance={"select"} options={category} onChange={categorySelector} value={selectedCategory?.name} error={discountForm.touched.category && discountForm.errors.category ? true : false}  />
              <label htmlFor="Sub Category" className="text-[#475569] text-sm">Sub Category</label>
              <CustomSelect appearance={"select"} options={selectedCategory?.subcategory} onChange={subcategorySelector} value={selectedSubcategory?.name} error={discountForm.touched.subCategory && discountForm.errors.subCategory ? true : false} />

              <Input styles="basic" name={'tags'} change={discountForm.handleChange} blur={discountForm.handleBlur} error={discountForm.touched.tags && discountForm.errors.tags ? discountForm.errors.tags : null}  value={discountForm.values.tags} label="Tags" placeholder="Tags" />
            </div>
            <div className="flex justify-between">
              <Button onClick={discountForm.resetForm} type="reset" style='outline'>Discard</Button>
