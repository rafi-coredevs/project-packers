		...
		terminal
			...
			.then((res) => {
				...
				requestForm.setValues({
					...
					link: res.link,
					note: res.note || res.note !== ''? res.note : 'N/A',
					price: res.price || 0,
					tax: res.tax || 0,
					fee: res.fee || 0,
				...
				<div className='col-span-3 sm:col-span-2 grid gap-5'>
					...
					<div className='grid gap-5 border border-[#0000001c] rounded-lg '>
						...
						<div className='flex gap-2 items-center px-5'>
							...
							<a
								href={requestForm.values.link.includes('https')? requestForm.values.link:`https://${requestForm.values.link}`}
							...
							<RequestImageUpload
								...
								placeholder={
									<>
										...
										<span className='text-[#3E949A] underline ml-1'>browse</span>
										<br />
						...
						<div className='grid gap-3 px-5'>
							...
							<textarea
								className='w-full text-[#475569] outline-none disabled:bg-transparent'
								name='note'
							...
							<div className='flex justify-between items-center px-5'>
								...
								<div className='flex gap-1 items-center'>
									...
									<Input
										...
										id='price'
										error={
											requestForm.touched.price && requestForm.errors.price
							...
							<div className='flex justify-between items-center px-5'>
								...
								<p className='text-lg font-semibold'>
									...
									{(Number(parseFloat(requestForm.values.price)) +
										...
										Number(parseFloat(requestForm.values.fee))).toFixed(4)}
								</p>
							</div>
